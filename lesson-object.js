...
// var eco = +prompt("Enter miles per galon")
// function economicCar(MilesperGallon) {
//     var ecoCar = []
//     for (let index = 0; index < carsArr.length; index++) {
//         if (MilesperGallon < carsArr[index].Miles_per_Gallon) {
//             ecoCar.push(carsArr[index])
//         }
...
// var result = economicCar(eco)
// console.log(result);



// console.log("Create a function that receive a book title and return a single book the first one.");
// var books = [
//     {
...
// }
// var foundBook = getBookname(bookName);
// console.log(foundBook);



// console.log("Create a function that receive a book author and return a single book the first one.");
// var books = [
//     {
//         "author": "Chinua Achebe",
//         "country": "Nigeria",
...
// var bookAuthor = prompt("Enter author")
...
// }
// var foundAuthor = getBookAuthor(bookAuthor);
// console.log(foundAuthor);



// console.log("write a function that input from user ( using prmopt ) 3 movies and push them to array.");

// var moviesArr = []
// var singleMovie = ""
// function getMovie(singleMovie) {
//     for (let index = 0; index <= 2; index++) {
//         var singleMovie = prompt("Enter movie name");
//         moviesArr.push(singleMovie)

//     }
// }
// getMovie(singleMovie)
// console.log(moviesArr);


// console.log("write a function that input from user rating number and return all the movies that higher than this rating");


// var singleMovie = [{ movieName: "armagedon", rating: 5 }, { movieName: "BARBIE", rating: 10 }, { movieName: "POOR THINGS", rating: 1 }]

// function getMovieRating(rating) {
//     var result = []
//     var getRating = +prompt("Enter movie rating")
//     for (let index = 0; index < singleMovie.length; index++) {
//         var singleRating = singleMovie[index].rating
//         if (getRating < singleRating) {
//             result.push(singleMovie[index])
//         }
...
console.log("write a function that delete a movie by movieName");

var allMovies = [{ movieName: "armagedon", rating: 5 }, { movieName: "BARBIE", rating: 10 }, { movieName: "POOR THINGS", rating: 1 }]

function deleteSingleMovie(movieName) {
    for (let index = 0; index < allMovies.length; index++) {
        var singleMovie = allMovies[index].movieName
        if (movieName === singleMovie) {
